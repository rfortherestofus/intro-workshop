...
Take your scatterplot that you just made and add a scale using `scale_fill_viridis_d`. 
...
Install and load the [`hrbrthemes` package](https://hrbrmstr.github.io/hrbrthemes/index.html). It's a package that provides some great default themes. I've installed it for you so you just need to load it.
